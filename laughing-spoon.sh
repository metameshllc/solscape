...
echo -e "\033[4mWelcome to laughing-spoon, a minimally-interactive bash script that automates pre-assessment (scoping) phase of security audits on Solidity code bases.\033[0m
"
sleep 2
...
"
sleep 1.5
echo "${bold}laughing-spoon.sh${normal} needs to point to the root directory of your smart contract system.
"
sleep 1
...
surya describe $contractRoot**/*.sol >> scopingReport.out || surya describe $contractRoot*.sol >> scopingReport.out
