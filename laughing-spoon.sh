...
echo -e "Welcome to laughing-spoon, a minimally-interactive bash script that automates pre-assessment (scoping) phase of security audits on Solidity code bases.
"
sleep 2
